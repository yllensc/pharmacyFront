...
// PURCHASED
export const getPurchase = "http://localhost:5223/api/pharmacy/Purchase";
export const postManyPurchases = "http://localhost:5223/api/pharmacy/Purchase/range";
...
export const end17 = "http://localhost:5223/api/pharmacy/Sale/average";
